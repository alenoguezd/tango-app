...
export interface SetProgress {
  ...
  title: string;
  cardCount: number;
  known: number;      // count of known cards
  toReview: number;   // count to review
  color?: "blue" | "pink";
}
...
// ── Dummy data (used as default) ───────────────────────────────────────────────
const DEFAULT_SETS: SetProgress[] = [
  { id: "set1",     title: "Set 1",     cardCount: 25, known: 18, toReview: 3,  color: "blue" },
  { id: "leccion2", title: "Lección 2", cardCount: 30, known: 20, toReview: 4,  color: "pink" },
  { id: "set2",     title: "Set 2",     cardCount: 25, known: 7,  toReview: 1,  color: "blue" },
];
  ...
  return (
    <div style={{
        ...
        <div style={{ padding: `0 ${H_PAD}px` }}>
          ...
          {sets.length === 0 ? (
            ...
            <div style={{
              ...
              <p style={{ fontFamily: FONT, fontSize: "16px", fontWeight: 500, color: TEXT_PRI, margin: 0 }}>
                Aún no has estudiado ningún set
              </p>
              <p style={{ fontFamily: FONT, fontSize: "14px", color: TEXT_MUT, margin: 0, lineHeight: 1.5 }}>
      ...
      >
        ...
        <NavItem label="Progreso" active         icon={<Play style={{ width: "20px", height: "20px", strokeWidth: 1.8 }} />}      onClick={() => {}} />
      </nav>
      ...
      <div style={{
        ...
        >
          <path
            ...
            fill={tabFill}
          />
          <rect x="0" y={TAB_H - 0.5} width={TAB_W} height={CARD_RADIUS + 1} fill={cardBg} />
        </svg>
        <span style={{
          position: "absolute",
          top: 0,
...
function StatCell({
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: "2px" }}>
      <span style={{ fontFamily: FONT, fontSize: "28px", fontWeight: 700, color, lineHeight: 1 }}>
        {value}
      </span>
      <span style={{ fontFamily: FONT, fontSize: "12px", fontWeight: 400, color: TEXT_SEC }}>
        {label}
      </span>
    </div>
  );
...
function ProgressBar({ value, showDot = false }: { value: number; showDot?: boolean }) {
  ...
  return (
    <div
      ...
      aria-valuemin={0}
      aria-valuemax={100}
      style={{ position: "relative", width: "100%", height: "5px", borderRadius: "99px", background: PROG_TRACK }}
    >
      <div style={{
        position: "absolute",
        left: 0, top: 0,
  ...
  return (
    <button
      ...
      style={{
        ...
        minHeight: "48px", background: "none", border: "none",
